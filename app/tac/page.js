...
function Page({}) {
    return (<div className={"__tac max-w-3xl mx-auto"}>
            <h2>Terms and Conditions </h2>

            <p>Welcome to Debite!</p>

            <p>These terms and conditions outline the rules and regulations for the use of Debite's Website, located at
                https://debite.org/.</p>

            <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Debite
            ...
            <p>We employ the use of cookies. By accessing Debite, you agreed to use cookies in agreement with the
                Debite's Privacy Policy. </p>
            ...
            <p>Unless otherwise stated, Debite and/or its licensors own the intellectual property rights for all
                material on Debite. All intellectual property rights are reserved. You may access this from Debite for
                your own personal use subjected to restrictions set in these terms and conditions.</p>

            <p>You must not:</p>
            <ul>
                <li>Republish material from Debite</li>
                <li>Sell, rent or sub-license material from Debite</li>
                <li>Reproduce, duplicate or copy material from Debite</li>
                <li>Redistribute content from Debite</li>
            </ul>

            <p>This Agreement shall begin on the date hereof. Our Terms and Conditions were created with the help of
                the <a href="https://seomagnifier.com/">Terms and Conditions Generator</a>.</p>

            <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
                certain areas of the website. Debite does not filter, edit, publish or review Comments prior to their
                presence on the website. Comments do not reflect the views and opinions of Debite,its agents and/or
                affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To
                the extent permitted by applicable laws, Debite shall not be liable for the Comments or for any
            ...
            <p>Debite reserves the right to monitor all Comments and to remove any Comments which can be considered
            ...
            <p>You hereby grant Debite a non-exclusive license to use, reproduce, edit and authorize others to use,
            ...
            <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us
                ...
                absence of Debite; and (d) the link is in the context of general resource information.</p>
            ...
            <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                website, you must inform us by sending an e-mail to Debite. Please include your name, your organization
            ...
            <p>No use of Debite's logo or other artwork will be allowed for linking absent a trademark license
                agreement.</p>
